...
namespace HaulToBuilding
{
    public class GameComponent_ExtraBillData : GameComponent
    {
        ...
        private Dictionary<Bill, ExtraBillData> data = new Dictionary<Bill, ExtraBillData>();
        private List<ExtraBillData> datas;
        private List<Bill> keys;

        public GameComponent_ExtraBillData(Game game)
        {
            Instance = this;
        }
    ...
    public class ExtraBillData : IExposable
    {
        ...
        public TakeFromData TakeFrom = new TakeFromData();
        ...
        public void ExposeData()
        {
            ...
            if (TakeFrom == null) TakeFrom = new TakeFromData();
        }

        public ExtraBillData Clone()
        {
            return new ExtraBillData
            {
        ...
        {
            private List<Building_Storage> buildings = new List<Building_Storage>();
            ...
            public IEnumerator<ISlotGroupParent> GetEnumerator()
            {
                return new SlotGroups(buildings, stockpiles);
            }
            ...
            {
                get => index >= buildings.Count ? (ISlotGroupParent) stockpiles[index - buildings.Count] : buildings[index];
                set
                {
            ...
            public bool Any()
            {
                return buildings.Any() || stockpiles.Any();
            }

            public TakeFromData Clone()
            {
                return new TakeFromData
                {
            ...
            public class SlotGroups : IEnumerator<ISlotGroupParent>
            {
                ...
                public ISlotGroupParent Current =>
                    finishedBuildings ? (ISlotGroupParent) stockpiles.Current : buildings.Current;
